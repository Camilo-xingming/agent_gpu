...
TB_BW_SCHED = $(TB_DIR)/tb_blackwell_scheduler.v
...
TB_SM_GMEM_ARB = $(TB_DIR)/tb_sm_gmem_arbiter.v
TB_TEX_SMEM_GMEM_INT = $(TB_DIR)/tb_texture_smem_gmem_integration.v
TB_SM_SPECIAL_REG = $(TB_DIR)/tb_sm_special_reg.v
...
TB_L1_DATA_CACHE_ACTIVE = $(TB_DIR)/tb_l1_data_cache_active.v
...
.PHONY: test_alu test_mul test_fma_int32 test_decoder test_regfile test_register_file_banked test_blackwell_scheduler test_bw_scheduler_scoreboard test_smem test_memory_coalescing_unit test_memory_interface test_memory_interface_wide test_l1_data_cache_optimized test_sm_fetch_pipeline test_sm_writeback_arbiter test_sm_gmem_arbiter test_texture_unit test_texture_smem_gmem_integration test_sm_special_reg test_memory_qos test_l2_interconnect test_reconvergence_stack test_simt_stack_controller test_lz4_decompressor test_chi_controller test_tensor_memory test_warp test_warp_collective_unit test_dual_issue_scheduler test_control_flow_unit test_branch_predictor test_icache test_cache_policy_unit test_forwarding_unit test_fpu test_fp16_unit test_fpu64 test_sfu test_cvt_unit test_dpx_unit benchmark test_atomic test_mbarrier_unit test_tma_unit test_multimem_unit test_cluster_barrier_unit test_warp_shuffle test_tlb test_tlb_enhanced test_performance_counters test_stack_debug_unit test_griddep_unit test_st_bulk_unit
.PHONY: test_sm_v2_integration test_sm_v2_comprehensive test_sm_v2_full test_sm_v2_perf test_sm_v2_perf_gemm16_ptx test_sm_v2_perf_gemm16_wmma_ptx test_sm_v2_perf_gemm64_wgmma_ptx test_sm_v2_perf_tensor test_sm_v2_perf_tensor_multiwarp test_sm_v2_sched_raw_hazard test_streaming_multiprocessor_v2 test_raw_hazard test_tensor_core_fp4 test_tensor_fp4_fp8 test_tensor_fp4_fp8_frm test_cron_optimization bench_l1d_ipc_compare bench_mcu_mem_compare dashboard dashboard-sprint21-baseline dashboard-check dashboard-baseline
.PHONY: test_vector_add test_perf_counters test_perf_mem_stream test_perf_mem_gather test_perf_saxpy test_multi_sm test_command_queue test_command_processor test_wb_fifo test_sm_wbq_bank test_ralph_gpu_top_cp_integration test_ralph_gpu_top_smoke test_memsys test_memory_controller test_l1_data_cache test_l1_data_cache_optimized test_l1_data_cache_active test_icache_lru test_phase2 test_warp_valid_d1 test_video_unit_ext
...
test_blackwell_scheduler: $(BUILD_DIR)/tb_blackwell_scheduler.vvp
	@echo "========================================"
	@echo "Running Blackwell Scheduler Unit Test"
	@echo "========================================"
	cd $(BUILD_DIR) && $(VVP) tb_blackwell_scheduler.vvp

$(BUILD_DIR)/tb_blackwell_scheduler.vvp: $(RTL_DIR)/blackwell_scheduler.v $(RTL_DIR)/gpu_defines.vh $(TB_BW_SCHED) | $(BUILD_DIR)
	$(IVERILOG) -g2012 $(INCLUDES) -o $@ $(TB_BW_SCHED) $(RTL_DIR)/blackwell_scheduler.v
...
test_memory_interface_wide: $(BUILD_DIR)/tb_memory_interface_wide.vvp
	@echo "========================================"
	@echo "Running Wide Memory Interface Unit Test"
	@echo "========================================"
	cd $(BUILD_DIR) && $(VVP) tb_memory_interface_wide.vvp

$(BUILD_DIR)/tb_memory_interface_wide.vvp: $(RTL_DIR)/memory_interface_wide.v $(RTL_DIR)/gpu_defines.vh $(RTL_DIR)/memory_config.vh $(TB_MEM_IF_WIDE) | $(BUILD_DIR)
	$(IVERILOG) -g2012 $(INCLUDES) -o $@ $(TB_MEM_IF_WIDE) $(RTL_DIR)/memory_interface_wide.v
...
test_sm_gmem_arbiter: $(BUILD_DIR)/tb_sm_gmem_arbiter.vvp
	@echo "========================================"
	@echo "Running SM GMEM Arbiter Unit Test"
	@echo "========================================"
	cd $(BUILD_DIR) && $(VVP) tb_sm_gmem_arbiter.vvp

$(BUILD_DIR)/tb_sm_gmem_arbiter.vvp: $(RTL_DIR)/sm_gmem_arbiter.v $(RTL_DIR)/gpu_defines.vh $(TB_SM_GMEM_ARB) | $(BUILD_DIR)
	$(IVERILOG) -g2012 $(INCLUDES) -o $@ $(TB_SM_GMEM_ARB) $(RTL_DIR)/sm_gmem_arbiter.v

test_sm_special_reg: $(BUILD_DIR)/tb_sm_special_reg.vvp
	@echo "========================================"
	@echo "Running SM Special Register Unit Test"
	@echo "========================================"
	cd $(BUILD_DIR) && $(VVP) tb_sm_special_reg.vvp

$(BUILD_DIR)/tb_sm_special_reg.vvp: $(RTL_DIR)/sm_special_reg.v $(RTL_DIR)/gpu_defines.vh $(TB_SM_SPECIAL_REG) | $(BUILD_DIR)
	$(IVERILOG) -g2012 $(INCLUDES) -o $@ $(TB_SM_SPECIAL_REG) $(RTL_DIR)/sm_special_reg.v
...
$(BUILD_DIR)/tb_branch_predictor.vvp: $(TB_DIR)/tb_branch_predictor.v $(RTL_DIR)/branch_predictor.v $(RTL_DIR)/gpu_defines.vh | $(BUILD_DIR)
	$(IVERILOG) -g2012 $(INCLUDES) -o $@ $(TB_DIR)/tb_branch_predictor.v $(RTL_DIR)/branch_predictor.v

test_icache: $(BUILD_DIR)/tb_icache.vvp
	@echo "========================================"
	@echo "Running I-Cache Unit Test"
	@echo "========================================"
	cd $(BUILD_DIR) && $(VVP) tb_icache.vvp

$(BUILD_DIR)/tb_icache.vvp: $(TB_DIR)/tb_icache.v $(RTL_DIR)/icache.v $(RTL_DIR)/gpu_defines.vh $(RTL_DIR)/memory_config.vh | $(BUILD_DIR)
	$(IVERILOG) -g2012 $(INCLUDES) -o $@ $(TB_DIR)/tb_icache.v $(RTL_DIR)/icache.v

test_cache_policy_unit: $(BUILD_DIR)/tb_cache_policy_unit.vvp
	@echo "========================================"
	@echo "Running Cache Policy Unit Test"
	@echo "========================================"
	cd $(BUILD_DIR) && $(VVP) tb_cache_policy_unit.vvp

$(BUILD_DIR)/tb_cache_policy_unit.vvp: $(TB_DIR)/tb_cache_policy_unit.v $(RTL_DIR)/cache_policy_unit.v $(RTL_DIR)/gpu_defines.vh | $(BUILD_DIR)
	$(IVERILOG) -g2012 $(INCLUDES) -o $@ $(TB_DIR)/tb_cache_policy_unit.v $(RTL_DIR)/cache_policy_unit.v
...
$(BUILD_DIR)/tb_forwarding_unit.vvp: $(TB_DIR)/tb_forwarding_unit.v $(RTL_DIR)/forwarding_unit.v $(RTL_DIR)/gpu_defines.vh | $(BUILD_DIR)
	$(IVERILOG) -g2012 $(INCLUDES) -o $@ $(TB_DIR)/tb_forwarding_unit.v $(RTL_DIR)/forwarding_unit.v
...
test_simt_stack_controller: $(BUILD_DIR)/tb_simt_stack_controller.vvp
	@echo "========================================"
	@echo "Running SIMT Stack Controller Unit Test"
	@echo "========================================"
	cd $(BUILD_DIR) && $(VVP) tb_simt_stack_controller.vvp

$(BUILD_DIR)/tb_simt_stack_controller.vvp: $(RTL_DIR)/reconvergence_stack.v $(RTL_DIR)/gpu_defines.vh $(TB_DIR)/tb_simt_stack_controller.v | $(BUILD_DIR)
	$(IVERILOG) -g2012 $(INCLUDES) -o $@ $(TB_DIR)/tb_simt_stack_controller.v $(RTL_DIR)/reconvergence_stack.v
...
test_dpx_unit: $(BUILD_DIR)/tb_dpx_unit.vvp
	@echo "========================================"
	@echo "Running DPX Unit Test"
	@echo "========================================"
	cd $(BUILD_DIR) && $(VVP) tb_dpx_unit.vvp

$(BUILD_DIR)/tb_dpx_unit.vvp: $(TB_DIR)/tb_dpx_unit.v $(RTL_DIR)/dpx_unit.v $(RTL_DIR)/gpu_defines.vh | $(BUILD_DIR)
	$(IVERILOG) -g2012 $(INCLUDES) -o $@ $(TB_DIR)/tb_dpx_unit.v $(RTL_DIR)/dpx_unit.v
...
TB_SM_V2_STREAMING = $(TB_DIR)/tb_streaming_multiprocessor_v2.v
...
test_sm_v2_integration: $(BUILD_DIR)/tb_sm_v2_integration.vvp
	@echo "========================================"
...
test_sm_v2_full: test_sm_v2_integration
	@echo "Alias target completed: test_sm_v2_integration"
...
# Dedicated streaming_multiprocessor_v2 integration coverage (Issue #603)
test_streaming_multiprocessor_v2: $(BUILD_DIR)/tb_streaming_multiprocessor_v2.vvp
	@echo "========================================"
	@echo "Running streaming_multiprocessor_v2 Dedicated TB"
	@echo "========================================"
	cd $(BUILD_DIR) && $(VVP) tb_streaming_multiprocessor_v2.vvp

$(BUILD_DIR)/tb_streaming_multiprocessor_v2.vvp: $(SM_V2_SRCS) $(TB_SM_V2_STREAMING) | $(BUILD_DIR)
	$(IVERILOG) -g2012 $(INCLUDES) $(RTL_DEFINES) -o $@ $(TB_SM_V2_STREAMING) $(filter %.v,$(SM_V2_SRCS))
...
help:
	...
	@echo "  test_control_flow_unit - Test control-flow reconvergence unit"
	@echo "  test_branch_predictor - Test branch predictor unit"
	@echo "  test_icache - Test instruction cache unit"
...
test_wgmma_tile_engine: $(BUILD_DIR)/tb_wgmma_tile_engine.vvp
	@echo "========================================"
	@echo "Running WGMMA Tile Engine Test"
	@echo "========================================"
	cd $(BUILD_DIR) && $(VVP) tb_wgmma_tile_engine.vvp
...
#----------------------------------------------------------------------------
# Texture -> SMEM -> GMEM Integration Test
#----------------------------------------------------------------------------
test_texture_smem_gmem_integration: $(BUILD_DIR)/tb_texture_smem_gmem_integration.vvp
	@echo "========================================"
	@echo "Running Texture-SMEM-GMEM Integration Test"
	@echo "========================================"
	cd $(BUILD_DIR) && $(VVP) tb_texture_smem_gmem_integration.vvp
...
test_mbarrier_unit: $(BUILD_DIR)/tb_mbarrier_unit.vvp
	@echo "========================================"
	@echo "Running mbarrier Unit Test"
	@echo "========================================"
	cd $(BUILD_DIR) && $(VVP) tb_mbarrier_unit.vvp

$(BUILD_DIR)/tb_mbarrier_unit.vvp: $(RTL_DIR)/mbarrier_unit.v $(RTL_DIR)/gpu_defines.vh tb/tb_mbarrier_unit.v | $(BUILD_DIR)
	$(IVERILOG) -g2012 $(INCLUDES) -o $@ tb/tb_mbarrier_unit.v $(RTL_DIR)/mbarrier_unit.v

test_tma_unit: $(BUILD_DIR)/tb_tma_unit.vvp
	@echo "========================================"
	@echo "Running TMA Unit Test"
	@echo "========================================"
	cd $(BUILD_DIR) && $(VVP) tb_tma_unit.vvp

$(BUILD_DIR)/tb_tma_unit.vvp: $(RTL_DIR)/tma_unit.v $(RTL_DIR)/gpu_defines.vh tb/tb_tma_unit.v | $(BUILD_DIR)
	$(IVERILOG) -g2012 $(INCLUDES) -o $@ tb/tb_tma_unit.v $(RTL_DIR)/tma_unit.v

test_multimem_unit: $(BUILD_DIR)/tb_multimem_unit.vvp
	@echo "========================================"
	@echo "Running Multimem Unit Test"
	@echo "========================================"
	cd $(BUILD_DIR) && $(VVP) tb_multimem_unit.vvp

$(BUILD_DIR)/tb_multimem_unit.vvp: $(RTL_DIR)/multimem_unit.v $(RTL_DIR)/gpu_defines.vh tb/tb_multimem_unit.v | $(BUILD_DIR)
	$(IVERILOG) -g2012 $(INCLUDES) -o $@ tb/tb_multimem_unit.v $(RTL_DIR)/multimem_unit.v

test_cluster_barrier_unit: $(BUILD_DIR)/tb_cluster_barrier_unit.vvp
	@echo "========================================"
	@echo "Running Cluster Barrier Unit Test"
	@echo "========================================"
	cd $(BUILD_DIR) && $(VVP) tb_cluster_barrier_unit.vvp

$(BUILD_DIR)/tb_cluster_barrier_unit.vvp: $(RTL_DIR)/cluster_barrier_unit.v $(RTL_DIR)/gpu_defines.vh tb/tb_cluster_barrier_unit.v | $(BUILD_DIR)
	$(IVERILOG) -g2012 $(INCLUDES) -o $@ tb/tb_cluster_barrier_unit.v $(RTL_DIR)/cluster_barrier_unit.v

test_warp_shuffle: $(BUILD_DIR)/tb_warp_shuffle.vvp
	@echo "========================================"
	@echo "Running Warp Shuffle Unit Test"
	@echo "========================================"
	cd $(BUILD_DIR) && $(VVP) tb_warp_shuffle.vvp
...
test_l2_cache: $(BUILD_DIR)/tb_l2_cache.vvp
	@echo "========================================"
	@echo "Running L2 Cache Unit Test"
	@echo "========================================"
	cd $(BUILD_DIR) && $(VVP) tb_l2_cache.vvp
...
test_ralph_gpu_top_smoke: $(BUILD_DIR)/tb_ralph_gpu_top_smoke.vvp
	...
	@echo "========================================"
	cd $(BUILD_DIR) && $(VVP) tb_ralph_gpu_top_smoke.vvp

$(BUILD_DIR)/tb_ralph_gpu_top_smoke.vvp: $(RTL_SRCS) $(TB_DIR)/tb_ralph_gpu_top_smoke.v | $(BUILD_DIR)
	$(IVERILOG) -g2012 $(INCLUDES) $(RTL_DEFINES) -o $@ $(TB_DIR)/tb_ralph_gpu_top_smoke.v $(filter %.v,$(RTL_SRCS))

test_wgmma_multiprecision: $(BUILD_DIR)/tb_wgmma_multiprecision.vvp
	@echo "========================================"
	@echo "Running test_wgmma_multiprecision"
	@echo "========================================"
	cd $(BUILD_DIR) && $(VVP) tb_wgmma_multiprecision.vvp
...
#----------------------------------------------------------------------------
# IPC Performance Gate Check
#----------------------------------------------------------------------------
test_perf_gate:
	@echo "Running IPC Performance Gate..."
	$(PYTHON) tools/check_ipc_gate.py
