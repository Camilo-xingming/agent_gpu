...
.PHONY: test_alu test_mul test_fma_int32 test_decoder test_regfile test_regfile_banked test_bw_scheduler_scoreboard test_smem test_memory_coalescing_unit test_memory_interface test_memory_qos test_reconvergence_stack test_lz4_decompressor test_chi_controller test_warp test_control_flow_unit test_sfu test_cvt_unit benchmark
