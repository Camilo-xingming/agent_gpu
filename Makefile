...
.PHONY: test_alu test_mul test_decoder test_regfile test_regfile_banked test_bw_scheduler_scoreboard test_smem test_memory_coalescing_unit test_memory_interface test_warp test_control_flow_unit test_sfu test_cvt_unit benchmark
...
# 运行所有测试
#----------------------------------------------------------------------------
test: test_alu test_mul test_decoder test_regfile test_smem test_memory_coalescing_unit test_memory_interface test_warp test_warp_ops test_video_unit test_tensor_core_e2e test_texture_unit test_command_queue test_command_processor test_wb_fifo
	@echo "========================================"
